...
; Mailman3 testing
lists-next           1H  IN MX   10 lists-next
lists-next           1H  IN TXT  "v=spf1 mx a:mx1001.wikimedia.org a:mx2001.wikimedia.org ~all"
_dmarc.lists-next    1H  IN TXT "v=DMARC1; p=none; rua=mailto:dmarc-rua@wikimedia.org; ruf=mailto:dmarc-ruf@wikimedia.org;"
_domainkey.lists-next        1H  IN TXT  "o=~; r=postmaster@wikimedia.org;"
_adsp._domainkey.lists-next  1H  IN TXT  "dkim=unknown;"
wikimedia._domainkey.lists-next  1H  IN TXT  "v=DKIM1; k=rsa; p="

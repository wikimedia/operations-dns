...
; TODO: this 'ns' should eventually go away when we are kind of sure that
; nobody is caching the NS entries pointing to it
ns                  5M  IN A      185.15.57.25  ; wmf-zone-validator-ignore=TOO_MANY_PUBLIC_NAMES,TOO_MANY_NAMES
ns0                 5M  IN A      185.15.57.25
ns1                 5M  IN A      208.80.153.44

ns-recursor0        5M  IN A      208.80.153.47
ns-recursor1        5M  IN A      208.80.153.50

; DNS servers by openstack designate. These addresses are BGP anycast VIPs
ns-recursor         5M  IN A      172.20.254.1

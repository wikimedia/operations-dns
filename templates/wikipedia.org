...
; SPF records
wikimedia.org.          600     IN TXT  "v=spf1 include:wikimedia.org ?all"

; temporary SPF record for fundraising tests, see T135410
donate                  600     IN TXT  "v=spf1 include:donate.wikimedia.org ?all"
